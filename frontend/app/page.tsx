...
import {
  Mic, Eye, Hand, Ear, Code, Shield, Brain, Wifi, Book, Accessibility, Gamepad2, MousePointer, TrendingUp,
      ...
      <section className="py-24 px-4 relative overflow-hidden">
        <div className="container mx-auto text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            ...
            <Link href="/defi"><Button size="lg" variant="outline" className="text-lg md:text-xl px-12 md:px-16 py-6 md:py-8 border-neon-green text-neon-green hover:bg-neon-green hover:text-black bg-transparent transition-smooth font-mono"><TrendingUp className="w-5 md:w-6 h-5 md:h-6 mr-4" />VOICE DEFI</Button></Link>
          </div>
        </div>
      </section>
