...
export default function UnifiedDashboardPage() {
  ...
  const handleQuickTransfer = (amount: number) => {
    ...
    toast({ title: "Transfer Initiated", description: `₦${amount.toLocaleString()} transfer prepared` })
  }
          ...
          <div className="lg:col-span-3">
            <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
                ...
                <div className="text-center">
                  ...
                  <div className="mt-6">
                    <p className="text-secondary text-xl font-mono">
                      {isListening ? "VOICE RECOGNITION ACTIVE..." : "TAP TO START VOICE COMMAND"}
                    </p>
                    ...
                    <CardContent className="space-y-4 pt-6">
                      {transactions.map((transaction) => (
                        <div key={transaction.id} className="flex items-center justify-between p-4 bg-surface rounded-lg border border-strong hover:border-neon-cyan transition-smooth cursor-pointer" tabIndex={0} role="button" aria-label={`Transaction ${transaction.type} ${transaction.amount} naira`}>
                          ...
                          <div className={`text-xl font-bold font-mono ${transaction.type === "received" ? "text-neon-green" : "text-neon-cyan"}`}>
              ...
              <TabsContent value="accessibility" className="space-y-6">
                <Card className="card-futuristic transition-smooth">
                  <CardHeader><CardTitle className="text-primary text-3xl flex items-center font-mono"><Settings className="w-8 h-8 mr-4 text-neon-green" />ACCESSIBILITY CONTROLS</CardTitle></CardHeader>
                  <CardContent className="space-y-6 pt-6">
                    ...
                    <div className="flex items-center justify-between p-4 bg-surface rounded-lg"><Label htmlFor="subtitles-enabled" className="text-lg text-primary font-mono">Live Captions / Subtitles</Label><Switch id="subtitles-enabled" checked={subtitlesEnabled} onCheckedChange={setSubtitlesEnabled} className="data-[state=checked]:bg-neon-green" /></div>
              ...
              <TabsContent value="security" className="space-y-6">
                <Card className="card-futuristic transition-smooth">
                  <CardHeader><CardTitle className="text-primary flex items-center font-mono"><Mic className="w-5 h-5 mr-2 text-neon-purple" />VOICE AUTHENTICATION</CardTitle><CardDescription className="text-secondary font-mono">Manage your voice authentication settings</CardDescription></CardHeader>
                  <CardContent className="space-y-4 pt-6">
              ...
              <TabsContent value="settings" className="space-y-6">
                 <Card className="card-futuristic transition-smooth">
                  <CardHeader><CardTitle className="text-primary flex items-center font-mono"><Zap className="w-5 h-5 mr-2 text-neon-orange" />USER PREFERENCES</CardTitle><CardDescription className="text-secondary font-mono">Customize your account settings</CardDescription></CardHeader>
                  <CardContent className="space-y-4 pt-6">
